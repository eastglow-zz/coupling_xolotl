...
[Mesh]
  ...
  ny = 120
  xmin = 0
  xmax = 1200  #1200 * lengthfactor
  ymin = 0
  ymax = 1200  #1200 * lengthfactor
  #uniform_refine = 3
[]
...
[GlobalParams]
  ...
  numbub = 1
  bubspac = 150
  radius = 44  #44 * lengthfactor
  int_width = 30  #30 * lengthfactor
[]
...
[ICs]
  ...
  [./etam0_IC]
    ...
    invalue = 0
    outvalue = 1
    x1 = 600   #600 * lengthfactor
    y1 = 600   #600 * lengthfactor
    radius = 44  #44 * lengthfactor
    int_width = 30  #30 * lengthfactor 
  [../]
  # [./etam1_IC]
...
# Densities
  ...
  [./const]
    ...
    prop_names =  'kappa0     mu0     L0         Dm   Db   Va      cvbubeq  cgbubeq gmb     gmm T     YXe'
    prop_values = '2.1125e2   1.875   2.2496e-4  0.1  0.1  0.0409  0.546    0.454   0.922  1.5  1200  0.2156'
  [../]
  [./kappa]
    type = ParsedMaterial
    f_name = kappa
    material_property_names = 'kappa0'
    function = 'kappa0 * ${lengthfactor}'
  [../]
  [./mu]
    type = ParsedMaterial
    f_name = mu
    material_property_names = 'mu0'
    function = 'mu0 / ${lengthfactor}'
  [../]
  [./L]
    type = ParsedMaterial
    f_name = L
    material_property_names = 'L0'
    function = 'L0 / ${lengthfactor}'
  [../]
